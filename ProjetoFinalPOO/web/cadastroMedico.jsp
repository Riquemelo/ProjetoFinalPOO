...
<%
   ...
   if (request.getParameter("cadastroMedico") != null) {
      ...
      Date registerDtNasc = new Date(format.parse(request.getParameter("dataNascimento")).getTime());
    ...
    <div class="container-fluid">
      ...
      <center>
        ...
        <form method="post">
          ...
          <input required type="text" class="data" name="dataNascimento" pattern="^[0-3][0-9]\/[0-1][0-9]\/[0-2][0-9]{3}$" placeholder="dd/mm/aaaa"/><br><br>
          <h6 style='font-style:italic'>Telefone: </h6>
          <input required type="text" class="telefone" name="telefoneMedico" placeholder="(00)0000-0000"/> <br><br>
